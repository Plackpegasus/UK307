    ...
    <div class="row">
        <div class="col">
            <form id="create-order" action="NEWORDER" method="post">
                <fieldset>
                    <legend>Neu Erstellung</legend>
                    <div>
                        <label for="user-name">Name:</label>
                        <input name="user-name" type="text" placeholder="Bitte geben Sie denn Namen des Kunden ein" required autofocus>
                    </div>
                    <div>
                        <label for="user-email">Email-Addresse:</label>
                        <input id="user-email" name="user-email" type="email" placeholder="Bitte geben Sie die Email-Address ein" required autofocus>
                    </div>
                    <div>
                        <label for="user-phonenumber">Telephonenummer:</label>
                        <input name="user-phonenumber" type="text" placeholder="Bitte geben Sie die Telephone Nummer ein">
                    </div>
                    <div>
                        <a>Prozente:</a>
